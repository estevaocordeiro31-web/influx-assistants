...
- [x] Integrar pontuação dos Games e Karaoke ao leaderboard (salvar no banco)
- [x] Modo multiplayer no Karaoke (dois alunos competem ao vivo)
- [x] Card do Karaoke no totem com QR Code direto para o game
